...
- Preserve the prior project-system boundary: six canonical recruiter projects; experimental work stays on `/lab`; employment/KPIT content remains out of scope.
