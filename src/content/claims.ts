...
export const claims: readonly Claim[] = [
  ...
  {
    id: "candidatex-research-cohort",
    project: "candidatex",
    claim: "Publication research cohort",
    value: "4,800",
    unit: " simulated candidates",
    status: "supported",
    method: "Repository research runner and publication artifacts; simulation-based, not real hiring outcomes",
    source: "CandidateX repository",
    lastVerified: "2026-09-17",
    evidenceUrl: "https://github.com/yorayriniwnl/CandidateX/blob/e68febbb0d82b3557f86b5b62dd4f3bf0323e092/research/run_paper_experiments.py",
  },
  {
