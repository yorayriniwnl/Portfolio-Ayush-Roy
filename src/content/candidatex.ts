...
export const candidateXProject: Project = {
  ...
  evidenceScope: "Repository evidence at commit e68febbb documents a Next.js 15 frontend, FastAPI backend, PostgreSQL/Redis infrastructure, static multi-language analysis, a Candidate Evidence Graph, role-capability scoring, and research experiment tooling. The published experiment results are simulation-based research evidence rather than validated hiring outcomes. A public CandidateX deployment is configured at candidatex-smoky.vercel.app.",
